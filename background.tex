\section{\bf Background and Objectives}\label{sec:background}
...
The regulation Major League Baseball ball has a circumference between $9 - 9\frac{1}{4}$ inches (229-235 mm) and weights $5-5\frac{1}{4}$ ounces (142-149 g)\footnote{MLB Official Rules: http://mlb.com}~%\cite{mlbrules}.  
