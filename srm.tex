...
\begin{figure}[ht]
  \centering
\includegraphics[width=0.36\columnwidth]{./pix/SRM.png}\includegraphics[width=0.36\columnwidth]{./pix/ThrowTrajDiag.png}\includegraphics[width=0.28\columnwidth]{./pix/hCol.png}
...
When testing the commanded trajectory produces the desired velocity of 4.9 m/s at 60$^o$.  This was then tested on the OpenHUBO and on the Jaemi Hubo platform, Fig~\ref{fig:3dThrowReal} and Fig~\ref{fig:3dThrowReal} respectively.
...
\includegraphics[width=0.25\columnwidth]{./pix/ddFinal/vHside5.png}\includegraphics[width=0.25\columnwidth]{./pix/ddFinal/vHside6.png}\includegraphics[width=0.25\columnwidth]{./pix/ddFinal/vHside7.png}\includegraphics[width=0.25\columnwidth]{./pix/ddFinal/vHside9.png}
...
To ensure balance throughout the motion the balance controller as described in Eq.~\ref{eq:bal} was applied and the static ZMP criteria was checked for the entire trajectory.
